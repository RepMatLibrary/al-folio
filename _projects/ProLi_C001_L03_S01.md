---
layout: pagebis
title: Artwork replica (C001_L03_S01)
description: from +LAB (A.R.)
img: assets/img/productlibrary/R_P_A_3_01.jpg
importance: 17
category: Product - Cluster 001
---
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/productlibrary/R_P_A_3_01.jpg" title="example image" class="img-fluid" %}
    </div>
</div>
<div class="caption">
    <i>Recycled PLA (2 recycling cycles)</i> - Sample #017
</div>

<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0" style="text-align:left">
  <a href="/projects/ProLi_C001_L02_S06/" target="_self"><b>←</b> Previous</a>
    </div>
    <div class="col-sm-4 mt-3 mt-md-0" style="text-align:center">
  <a href="/productlibrary/" target="_self"><b>↶</b> Back</a>
    </div>
    <div class="col-sm-4 mt-3 mt-md-0" style="text-align:right">
        <td align="right"><a href="/projects/ProLi_C001_L03_S02/" target="_self"><b>→</b> Next</a></td>
    </div>
</div>
<br>
...
<div class="row justify-content-sm-left">
    ...
    <div class="col-sm-9 mt-3 mt-md-0" style="text-align:left">
        Freeform shapes, irregular shape, small cross-sections.
    </div>
</div>
<div class="row justify-content-sm-left">
    <div class="col-sm-3 mt-3 mt-md-0" style="text-align:left">
    ...
    <div class="col-sm-9 mt-3 mt-md-0" style="text-align:left">
        Possible application (already tested).
    </div>
</div>
<br>
...
<div class="row justify-content-sm-left">
    ...
    <a href="https://www.thingiverse.com/thing:1892710" title="3D model - Venus (Stl)">
        <i class='fa fa-cube' style='font-size:3rem'></i></a>
    <br><b>3D model - Venus (Stl)</b>
    </div>
        <div class="col-sm-2 mt-3 mt-md-0" style="text-align:center">
        <a href="https://www.thingiverse.com/thing:502967" title="3D model - David (Stl)">
            <i class='fa fa-cube' style='font-size:3rem'></i></a>
        <br><b>3D model - David (Stl)</b>
        </div>
            <div class="col-sm-2 mt-3 mt-md-0" style="text-align:center">
            <a href="https://lartediripartire.com/about/" title="Cicatr/ci Milano (Link)">
                <i class='fas fa-calendar-alt' style='font-size:3rem'></i></a>
            <br><b>Cicatr/ci Milano (Link)</b>
            </div>
                <div class="col-sm-2 mt-3 mt-md-0" style="text-align:center">
                <a href="https://triennale.org/eventi/cicatrci-milano" title="Cicatr/ci Milano (Triennale)">
                    <i class='far fa-calendar-check' style='font-size:3rem'></i></a>
                <br><b>Cicatr/ci Milano (Triennale)</b>
                </div>
...
<br>This 3D model is a cut-off (face detail) of the <b>Venere</b> (Venus) 3D model replica (total height of two meters). This application has been inspired by the project <b>Cicatr/ci Milano</b>, where +LAB previously participated to produce some large-format art replicas.
