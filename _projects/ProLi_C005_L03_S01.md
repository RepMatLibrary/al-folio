---
layout: pagebis
title: Cntool (C005_L03_S01)
description: from +LAB (A.R.)
img: assets/img/productlibrary/R_P_E_3_01.jpg
importance: 20
category: Product - Cluster 005
---
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/productlibrary/R_P_E_3_01.jpg" title="example image" class="img-fluid" %}
    </div>
</div>
<div class="caption">
    <i>Spent Coffee Ground + PLA</i> - Sample #020
</div>

<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0" style="text-align:left">
  <a href="/projects/ProLi_C005_L02_S03/" target="_self"><b>←</b> Previous</a>
    </div>
    <div class="col-sm-4 mt-3 mt-md-0" style="text-align:center">
  <a href="/productlibrary/" target="_self"><b>↶</b> Back</a>
    </div>
    <div class="col-sm-4 mt-3 mt-md-0" style="text-align:right">
        <td align="right"><a href="/projects/ProLi_C006_L01_S01/" target="_self"><b>→</b> Next (cluster)</a></td>
    </div>
</div>
<br>
...
<h5>Furniture and exhibition - Seat elements and exhibition with customized paths</h5>
...
<br>This 3D model is a scaled version of <b>XYZ</b>, a customizable and reconfigurable stool and rack. The original concept has been developed during the Ph.D. research period abroad of Alessia Romani at FAST Lab (Western University) and the work at +LAB (Politecnico di Milano). It is currently under development.


<br>
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.html path="assets/img/detailsproducts/01_ProLi_C005_L03.jpg" title="example image" class="img-fluid" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.html path="assets/img/detailsproducts/02_ProLi_C005_L03.jpg" title="example image" class="img-fluid" %}
    </div>
</div>
<br>
<div class="row justify-content-sm-center">
  <div class="col-sm-4 mt-3 mt-md-0">
    {% include figure.html path="assets/img/detailsproducts/03_ProLi_C005_L03.jpg" title="example image" class="img-fluid" %}
    </div>
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.html path="assets/img/detailsproducts/04_ProLi_C005_L03.jpg" title="example image" class="img-fluid" %}
    </div>
</div>
<hr>
